...
- Home, hours, pricing, contact, join, and tour use local `/public/placeholders` gym photos (v2: aisle hero, Precor runner visit). Rejected v1 hero/visit shots live unwired in `/public/images/alts/`.
